...
<div>
<h4 class="text-lg font-extrabold tracking-tight">TruvoLabs.com</h4>
<p class="text-[10px] font-bold text-secondary uppercase tracking-widest mt-1">Highly Brandable</p>
</div>
<div class="text-right">
<p class="text-xl font-black">$3,495</p>
<span class="text-[10px] text-secondary">Buy Now</span>
</div>
</div>
<div class="bg-surface-container-lowest p-5 rounded-xl border border-outline-variant/30 flex justify-between items-center group cursor-pointer hover:border-primary transition-all">
<div>
<h4 class="text-lg font-extrabold tracking-tight">Trovally.com</h4>
<p class="text-[10px] font-bold text-secondary uppercase tracking-widest mt-1">Abstract Authority</p>
</div>
<div class="text-right">
<p class="text-xl font-black">$3,499</p>
<span class="text-[10px] text-secondary">Buy Now</span>
</div>
</div>
<div class="bg-surface-container-lowest p-5 rounded-xl border border-outline-variant/30 flex justify-between items-center group cursor-pointer hover:border-primary transition-all">
<div>
<h4 class="text-lg font-extrabold tracking-tight">TrovaHub.com</h4>
<p class="text-[10px] font-bold text-secondary uppercase tracking-widest mt-1">Ecosystem Ready</p>
</div>
<div class="text-right">
<p class="text-xl font-black">$4,250</p>
<span class="text-[10px] text-secondary">Buy Now</span>
</div>
</div>
<div class="bg-surface-container-lowest p-5 rounded-xl border border-outline-variant/30 flex justify-between items-center group cursor-pointer hover:border-primary transition-all">
<div>
<h4 class="text-lg font-extrabold tracking-tight">Latrova.com</h4>
<p class="text-[10px] font-bold text-secondary uppercase tracking-widest mt-1">Modern Luxury</p>
</div>
<div class="text-right">
<p class="text-xl font-black">$2,800</p>
<span class="text-[10px] text-secondary">Buy Now</span>
</div>
</div>
</div>
...
<span class="font-['Manrope'] font-bold text-2xl text-black dark:text-white">ARCHITECT.AI</span>
...
<span class="text-neutral-400 dark:text-neutral-600 text-sm tracking-wide font-['Inter']">&copy; 2024 Architect Digital Identity. All rights reserved.</span>
