...
<section class="hero-gradient min-h-[820px] flex items-center px-6 relative overflow-hidden">
  <div class="max-w-7xl w-full mx-auto z-10 hero-grid py-16">
    ...
    <div class="max-w-3xl">
      ...
      <form id="hero-search-form" action="/pages/whois_ai_domain_search.php" method="GET" class="relative max-w-2xl glass-panel p-1.5 rounded-full shadow-lg flex items-center border border-outline-variant/30 hover:shadow-primary/5 transition-all">
...
(function () {
  ...
  function setMode(next) {
    ...
    if (mode === 'ai') {
      ...
      form.action = '/pages/whois_ai_domain_search.php';
  ...
  form.addEventListener('submit', function(e) {
    if (form.dataset.aiMode) {
      ...
      window.location.href = '/pages/whois_ai_generated_domains.php?idea=' + encodeURIComponent(q);
    }
  });
