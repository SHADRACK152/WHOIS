...
<div class="admin-layout">
  <aside class="admin-sidebar sticky top-0 h-screen overflow-y-auto">
    <div class="sidebar-top p-5 border-b border-outline-variant/20">
      ...
      <div class="mt-4 px-3 py-2 rounded-xl bg-emerald-500/5 border border-emerald-500/10 flex items-center gap-2">
        <span class="relative flex h-2 w-2">
          <span class="animate-ping absolute inline-flex h-full w-full rounded-full bg-emerald-400 opacity-75"></span>
          <span class="relative inline-flex rounded-full h-2 w-2 bg-emerald-500"></span>
        </span>
        <span class="text-[9px] font-black uppercase tracking-[0.1em] text-emerald-600">Active Session</span>
      </div>
    </div>
